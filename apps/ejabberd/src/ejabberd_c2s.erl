        ...
        _ ->
            case {should_retransmit_last_presence(LFrom, LBareFrom, StateData),
                ...
                {true, _} ->
                    ...
                    check_privacy_and_route_probe(StateData, From, To, Packet);
                {false, true} ->
...
-spec check_privacy_and_route_or_ignore(Acc :: mongoose_acc:t(),
                                        ...
                                        Packet :: exml:element(),
                                        Dir :: in | out) -> any().
check_privacy_and_route_or_ignore(Acc, StateData, From, To, _Packet, Dir) ->
    {Acc1, Res} = privacy_check_packet(Acc, To, Dir, StateData),
    case Res of
        allow -> ejabberd_router:route(From, To, Acc1);
        _ -> Acc1
    end.
